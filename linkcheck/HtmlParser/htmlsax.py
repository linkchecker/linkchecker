...
from bs4 import (
    BeautifulSoup, CData, Comment, Doctype, ProcessingInstruction, Tag,
)
...
class Parser(object):
    ...
    def lineno(self):
        ...
        # implemented in BeatifulSoup, so this is faked
        return 0
    ...
    def peek(self, peek_len):
        raise NotImplementedError(
            "Peeking is deprecated in favor of 'handler.start_element' "
